        ...
        dt.dataTable({
            ...
            "columnDefs": [
                ...
                },
                {
                    "targets": [14],
                    'createdCell': function (td, cellData, rowData, row, col) {
                        $(td).attr('data-title', $("#product-product-list thead tr th:eq(14)").html());
                    }
                },
                {
                    "targets": [15],
                    'createdCell': function (td, cellData, rowData, row, col) {
                        $(td).attr('data-title', $("#product-product-list thead tr th:eq(15)").html());
                    }
                },
                {
                    "targets": [16],
                    'createdCell': function (td, cellData, rowData, row, col) {
                        $(td).attr('data-title', $("#product-product-list thead tr th:eq(16)").html());
                    }
                },
                {
                    "targets": [17],
                    'createdCell': function (td, cellData, rowData, row, col) {
                        $(td).attr('data-title', $("#product-product-list thead tr th:eq(17)").html());
                    }
                },
                {
                    "targets": [18],
                    'createdCell': function (td, cellData, rowData, row, col) {
                        $(td).attr('data-title', $("#product-product-list thead tr th:eq(18)").html());
                    }
                },
                {
                    "targets": [19],
                    'createdCell': function (td, cellData, rowData, row, col) {
                        $(td).attr('data-title', $("#product-product-list thead tr th:eq(19)").html());
                    }
                },
                {
                    "targets": [20],
            ...
            "aoColumns": [
                ...
                { data: "UOM_Medium" },
                { data: "Volume_Unit_Medium" },
                { data: "Selling_Price_Medium" },
                { data: "UOM_Small" },
                { data: "sell_price" },
                { data: "view_btn" },
                { data: "edit_btn" },
