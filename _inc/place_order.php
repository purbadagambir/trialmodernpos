...
if ($request->server['REQUEST_METHOD'] == 'POST') {
  try {
    ...
    // Validate Cash to Credit
    // if (!validateFloat($request->post['balance-to-credit'])) {
    //   throw new Exception(trans('error_amount_of_balance_to_credit'));
    // }
    // End update by henry @09-06-2022

    // Validate invoice items
    if (
      !isset($request->post['product-item'])
