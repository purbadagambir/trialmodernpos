...
$columns = array(
  ...
  array( 
    ...
    'dt' => 'withdraw' ,
    'formatter' => function($d, $row) {
        return number_format($row['withdraw']);
    }
  ),
  array( 
    ...
    'formatter' => function($d, $row) {
        return number_format($row['transfer_to_other']);
    }
  ),
  array( 
    ...
    'formatter' => function($d, $row) {
        return number_format($row['transfer_from_other']);
    }
  ),
  array( 
    'db' => 'id',   
    'dt' => 'balance' ,
    'formatter' => function($d, $row) {
        return number_format(($row['deposit'] + $row['transfer_from_other']) - ($row['withdraw'] + $row['transfer_to_other']));
    }
  ),
); 
