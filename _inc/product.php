...
$columns = array(
  ...
  array( 
    'db' => 'vol_unit_medium',   
    'dt' => 'Volume_Unit_Medium' ,
    'formatter' => function($d, $row) {
      return currency_format($row['vol_unit_medium']);
    }
  ),
  array( 
    'db' => 'vol_unit_large',   
    'dt' => 'Volume_Unit_Large' ,
    'formatter' => function($d, $row) {
      return currency_format($row['vol_unit_large']);
    }
  ),
  array( 
    'db' => 'sell_price_medium',   
    'dt' => 'Selling_Price_Medium' ,
    'formatter' => function($d, $row) {
      return currency_format($row['sell_price_medium']);
    }
  ),
  array( 
    'db' => 'sell_price_large',   
    'dt' => 'Selling_Price_Large' ,
    'formatter' => function($d, $row) {
      return currency_format($row['sell_price_large']);
    }
  ),
  array( 
    'db' => 'box_name',   
