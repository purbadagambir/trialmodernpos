        ...
        <div class="tab-pane<?php echo $tab_active == 'general' ? ' active' : null; ?>" id="general">
          ...
          <div class="form-group">
            <label for="sell_price" class="col-sm-3 control-label">
              <?php echo trans('label_product_price_small'); ?><i class="required">*</i>
            </label>
            <div class="col-sm-8">
          ...
          <div ng-hide="hideUnit" class="form-group">
            <label for="unit_id" class="col-sm-3 control-label">
              <?php echo trans('label_unit_small'); ?><i class="required">*</i>
            </label>
            <div class="col-sm-8">
          ...
          <div ng-hide="hideUnit" class="form-group">
            <label for="unit_id" class="col-sm-3 control-label">
              <?php echo trans('label_unit_medium'); ?><i class="required">*</i>
            </label>
            <div class="col-sm-4">
            ...
            <div class="col-sm-2">
              <input type="text" class="form-control" id="vol_unit_medium" value="<?php echo $product['vol_unit_medium']; ?>" name="vol_unit_medium" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" onKeyUp="if(this.value<0){this.value='1';}" required>
            </div>
            <div class="col-sm-2">
              <input type="text" step="0.01" class="form-control" id="sell_price_medium" value="<?php echo $product['sell_price_medium']; ?>" name="sell_price_medium" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" onKeyUp="if(this.value<0){this.value='1';}" required>
            </div>
          </div>

          <div ng-hide="hideUnit" class="form-group">
            <label for="unit_id" class="col-sm-3 control-label">
              <?php echo trans('label_unit_large'); ?><i class="required">*</i>
            </label>
            <div class="col-sm-4">
            ...
            <div class="col-sm-2">
              <input type="text" class="form-control" id="vol_unit_large" value="<?php echo $product['vol_unit_large']; ?>" name="vol_unit_large" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" onKeyUp="if(this.value<0){this.value='1';}" required>
            </div>
            <div class="col-sm-2">
              <input type="text" step="0.01" class="form-control" id="sell_price_large" value="<?php echo $product['sell_price_large']; ?>" name="sell_price_large" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" onKeyUp="if(this.value<0){this.value='1';}" required>
            </div>
          </div>
