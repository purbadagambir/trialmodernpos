  ...
  <div class="box-body">
    ...
    <div class="form-group">
      <label for="unit_id" class="col-sm-3 control-label">
        <?php echo trans('label_UOM.VOL.PRICE_Small'); ?>
      </label>
      <div class="col-sm-3">
      ...
      <div class="col-sm-2">
        <input type="number" class="form-control" id="alert_quantity" name="alert_quantity" value="<?php echo format_input_number($product['vol_unit_small']); ?>" readonly>
      </div>
      <div class="col-sm-2">
        <input type="number" class="form-control" id="alert_quantity" name="alert_quantity" value="<?php echo format_input_number($product['sell_price']); ?>" readonly>
      </div>
    </div>

    <div class="form-group">
      <label for="unit_medium" class="col-sm-3 control-label">
        <?php echo trans('label_UOM.VOL.PRICE_Medium'); ?>
      </label>
      <div class="col-sm-3">
        <select class="form-control" name="unit_medium" readonly disabled>
            <option value="">
              <?php echo trans('text_select'); ?>
            </option>
            <?php foreach(get_units() as $unit_row) {
                if($unit_row['unit_id'] == $product['unit_id_medium']) { ?>
                  <option value="<?php echo $unit_row['unit_id_medium']; ?>" selected><?php echo $unit_row['unit_name']; ?></option><?php
                } else {
                  ?>
                  <option value="<?php echo $unit_row['unit_id']; ?>">
                    <?php echo $unit_row['unit_name']; ?>
      ...
      <div class="col-sm-2">
        <input type="number" class="form-control" id="alert_quantity" name="alert_quantity" value="<?php echo format_input_number($product['vol_unit_medium']); ?>" readonly>
      </div>
      <div class="col-sm-2">
        <input type="number" class="form-control" id="alert_quantity" name="alert_quantity" value="<?php echo format_input_number($product['sell_price_medium']); ?>" readonly>
      </div>
    </div>

    <div class="form-group">
      <label for="unit_medium" class="col-sm-3 control-label">
        <?php echo trans('label_UOM.VOL.PRICE_Large'); ?>
      </label>
      <div class="col-sm-3">
        <select class="form-control" name="unit_large" readonly disabled>
            <option value="">
              <?php echo trans('text_select'); ?>
            </option>
            <?php foreach(get_units() as $unit_row) {
                if($unit_row['unit_id'] == $product['unit_id_large']) { ?>
                  <option value="<?php echo $unit_row['unit_id_large']; ?>" selected><?php echo $unit_row['unit_name']; ?></option><?php
                } else {
                  ?>
                  <option value="<?php echo $unit_row['unit_id']; ?>">
                    <?php echo $unit_row['unit_name']; ?>
      ...
      <div class="col-sm-2">
        <input type="number" class="form-control" id="alert_quantity" name="alert_quantity" value="<?php echo format_input_number($product['vol_unit_large']); ?>" readonly>
      </div>
      <div class="col-sm-2">
        <input type="number" class="form-control" id="alert_quantity" name="alert_quantity" value="<?php echo format_input_number($product['sell_price_large']); ?>" readonly>
      </div>
    </div>
