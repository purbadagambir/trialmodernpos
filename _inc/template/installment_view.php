						...
						<?php foreach ($payments as $payment): ?>
                          	<tr class="bt-1">
	                            ...
	                            <td class="w-10 text-right">
	                                <?php echo number_format($payment['interest']);?>
	                            </td>
	                            <td class="w-10 text-right">
	                                <?php echo number_format($payment['payable']);?>
	                            </td>
	                            <td class="w-10 text-right">
	                                <?php echo number_format($payment['paid']);?>
	                            </td>
	                            <td class="w-10 text-right">
	                                <?php echo number_format($payment['due']);?>
	                            </td>
			...
			<table class="table table-bordered table-striped mb-0">
				<tbody>
					...
					<tr>
						...
						<td class="w-70">
							<?php echo number_format($invoice['payable_amount']); ?>
						</td>
					</tr>
					<tr>
						<td class="w-30 text-right bg-gray">
						...
						<td class="w-70">
							<?php echo number_format($invoice['initial_amount']); ?>
						</td>
					</tr>
					<tr>
						<td class="w-30 text-right bg-gray">
					...
					<tr>
						...
						<td class="w-70">
							<?php echo number_format($invoice['interest_percentage']); ?> %
						</td>
					</tr>
					<tr>
						<td class="w-30 text-right bg-gray">
						...
						<td class="w-70">
							<?php echo number_format($invoice['interest_amount']); ?>
						</td>
					</tr>
					<tr>
						<td class="w-30 text-right bg-gray">
