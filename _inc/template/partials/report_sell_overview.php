    ...
    <tbody>
      <tr>
        ...
        <td class="text-center bg-green">
          ...
          <h2 class="price">
            <?php echo number_format(discount_amount(from(), to())); ?>
          </h2>
        </td>
      ...
      <tr>
        <td class="text-center bg-green">
          ...
          <h2 class="price">
            ...
            echo number_format($due_collection_amount); ?>
          </h2>
          <br>
      ...
      <tr>
        ...
        <td class="text-center danger">
          ...
          <h2 class="price">
            <?php echo number_format($sell_return_amount); ?>
          </h2>
          <br>
    ...
    <tbody>  
      ...
      <tr>
        ...
        <td class="text-center danger">
          ...
          <h2 class="price">
            <?php echo number_format($tax_return_amount); ?>
          </h2>
        </td>
        <td class="text-center danger">&nbsp;</td>
      </tr>
    ...
    <tbody>  
      ...
      <tr>
        ...
        <td class="text-center danger">
          <h4><?php echo trans('text_substract_amount'); ?> <small>(for sell return)</small></h4>
          <h2 class="price">
            <?php echo number_format($gst_return_amount); ?>
          </h2>
        </td>
        <td class="text-center danger">&nbsp;</td>
      </tr>
