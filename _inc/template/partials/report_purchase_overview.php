      ...
      <tr>
        <td class="text-center bg-blue">
          ...
          <h2 class="price">
            ...
            echo number_format($purchase_price); ?>
          </h2>
          <br>
        ...
        <td class="text-center bg-green">
          ...
          <h2 class="price">
            <?php echo number_format(purchase_discount_amount(from(), to())); ?>
          </h2>
        </td>
        <td class="text-center bg-red">
          ...
          <h2 class="price">
            <?php 
              ...
              echo number_format($total_due_amount);?>
          </h2>
          <br>
      ...
      <tr>
        <td class="text-center bg-green">
          ...
          <h2 class="price">
            ...
            echo number_format($due_paid_amount); ?>
          </h2>
          <br>
        ...
        <td class="text-center bg-purple">
          ...
          <h2 class="price">
            <?php 
              ...
              echo number_format($shipping_charge); ?>
          </h2>
          <br>
        ...
        <td class="text-center bg-yellow">
          ...
          <h2 class="price">
            <?php 
              ...
              echo number_format($others_charge); ?>
          </h2>
          <br>
          <a href="purchase.php?type=paid" class="text-yellow">
            <?php echo trans('button_details'); ?> &rarr;
      ...
      <tr>
        <td class="text-center bg-purple">
          ...
          <h2 class="price">
            <?php 
              ...
              echo number_format($purchase_total_paid); ?>
          </h2>
          <br>
          <a href="purchase.php?type=paid" class="text-yellow">
            <?php echo trans('button_details'); ?> &rarr;
        ...
        <td class="text-center danger">
          ...
          <h2 class="price">
            ...
            echo number_format($purchase_return_amount); ?>
          </h2>
          <br>
    ...
    <tbody>  
      ...
      <tr>
        ...
        <td class="text-center danger">
          ...
          <h2 class="price">
            <?php echo number_format($purchase_tax_return_amount); ?>
          </h2>
        </td>
        <td class="text-center danger">&nbsp;</td>
      </tr>
    ...
    <tbody>  
      ...
      <tr>
        ...
        <td class="text-center danger">
          <h4><?php echo trans('text_substract_amount'); ?> <small>(for sell return)</small></h4>
          <h2 class="price">
            <?php echo number_format($purchase_gst_return_amount); ?>
          </h2>
        </td>
        <td class="text-center danger">&nbsp;</td>
      </tr>
