					...
					<tbody>
						<?php $inc=1;foreach ($quotation_items as $product) : ?>
							<tr>
								...
								<td class="text-right">
									<?php echo number_format($product['item_price']); ?>
								</td>
								<td class="text-right">
									<?php echo number_format($product['item_tax']); ?>
								</td>
								<td class="text-right">
					...
					<tfoot>
						<tr class="bg-gray">
							...
							<td class="w-20 text-right">
								<?php echo number_format($quotation['subtotal']+$quotation['item_tax']); ?>
							</td>
						</tr>
						<tr class="bg-gray">
							<td class="text-right" colspan="4">
							...
							<td class="w-20 text-right">
								<?php echo number_format($quotation['discount_amount']); ?>
							</td>
						</tr>
						<tr class="bg-gray">
							<td class="text-right" colspan="4">
							...
							<td class="w-20 text-right">
								<?php echo number_format($quotation['order_tax']); ?>
							</td>
						</tr>
						<tr class="bg-gray">
							<td class="text-right" colspan="4">
							...
							<td class="w-20 text-right">
								<?php echo number_format($quotation['shipping_amount']); ?>
							</td>
						</tr>
						<tr class="bg-gray">
							...
							<td class="w-20 text-right" style="font-weight:bold">
								<?php echo number_format($quotation['payable_amount']); ?>
							</td>
						</tr>
					</tfoot>
				</table>
