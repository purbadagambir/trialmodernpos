              ...
              <tbody>   
                <?php foreach ($quotation_items as $item):?>
                  <tr id="<?php echo $item['item_id'];?>" class="58" data-item-id="<?php echo $item['item_id'];?>">
                    ...
                    <td class="text-center"><?php echo number_format(get_the_product($item['item_id'],'quantity_in_stock'));?></td>
                    ...
                    <td class="text-center" data-title="Tax Amount">
                      ...
                      <span class="tax-amount-view"><?php echo number_format($item['item_tax']*$item['item_quantity']);?></span>
                    </td>
                    <td class="text-right" data-title="Total">
                      ...
                      <span class="subtotal-" id="subtotal-<?php echo $item['item_id'];?>"><?php echo number_format($item['item_total']);?>
                      </span>
                    </td>
              ...
              <tfoot>
                <tr class="bg-gray rm-in-action">
                  ...
                  <th class="col-sm-2 text-right">
                    <span><?php echo number_format($quotation['subtotal']+$quotation['item_tax']);?></span>
                  </th>
                  <th class="w-25p">&nbsp;</th>
                </tr>
                <tr class="bg-gray rm-in-action">
                  ...
                  <th class="col-sm-2 text-right">
                    <span><?php echo number_format($quotation['discount_amount']);?></span>
                  </th>
                  <th class="w-25p">&nbsp;</th>
                </tr>
                <tr class="bg-gray rm-in-action">
                  ...
                  <th class="col-sm-2 text-right">
                    <span><?php echo number_format($quotation['order_tax']);?></span>
                  </th>
                  <th class="w-25p">&nbsp;</th>
                </tr>
                <tr class="bg-gray rm-in-action">
                  ...
                  <th class="col-sm-2 text-right">
                    <span><?php echo number_format($quotation['shipping_amount']);?></span>
                  </th>
                  <th class="w-25p">&nbsp;</th>
                </tr>
                <tr class="bg-success">
                  ...
                  <th class="col-sm-2 text-right">
                    ...
                    <span id="total-amount-view"><?php echo number_format($quotation['payable_amount']);?></span>
                  </th>
                  <th class="w-25p">&nbsp;</th>
                </tr>
              </tfoot>
