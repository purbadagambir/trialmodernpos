					...
					<tfoot>
						<tr>
							...
							<td class="w-20 text-right">
								<?php echo number_format($order['subtotal']+$order['item_tax']); ?>
							</td>
						</tr>
						<tr>
							<td class="text-right" colspan="4">
							...
							<td class="w-20 text-right">
								<?php echo number_format($order['order_tax']); ?>
							</td>
						</tr>
						<tr>
							<td class="text-right" colspan="4">
							...
							<td class="w-20 text-right">
								<?php echo number_format($order['shipping_amount']); ?>
							</td>
						</tr>
						<tr>
							<td class="text-right" colspan="4">
							...
							<td class="w-20 text-right">
								<?php echo number_format($order['others_charge']); ?>
							</td>
						</tr>
						<tr>
							<td class="text-right" colspan="4">
						...
						<tr>
							...
							<td class="w-20 text-right" style="font-weight:bold">
								<?php echo number_format($order['payable_amount']); ?>
							</td>
						</tr>
