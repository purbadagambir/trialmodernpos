			...
			<table class="table table-bordered table-striped table-condensed">
				<tbody>
					...
					<tr>
						...
						<td class="w-70">
							<?php echo number_format($invoice['total_item']); ?>
						</td>
					</tr>
					<tr>
						<td class="w-30 bg-gray text-right">
						...
						<td class="w-70">
							<?php echo number_format($invoice['total_quantity']); ?>
						</td>
					</tr>
					<tr>
						<td class="w-30 bg-gray text-right">
					...
					<tbody>
						<?php foreach ($invoice_items as $product) : ?>
							<tr>
								...
								<td class="text-right">
									<?php echo number_format($product['item_quantity']); ?> <?php echo get_the_unit($product['item_id'],'unit_name'); ?>
								</td>
								<td class="text-right">
