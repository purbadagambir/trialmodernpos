	...
	<tbody>
			...
			foreach ($invoices as $invoice) : ?>
				...
				<tr>
					...
					<td class="text-right">
						...
						echo number_format($invoice['item_total_price']); ?></td>
					<td class="text-right">
						<?php 
						$total_item_discount += $invoice['item_discount'];
						echo number_format($invoice['item_discount']); ?></td>
					<td class="text-right">
						<?php 
						$total_net_amount += $invoice['item_total_price'] - $invoice['item_discount'];
						echo number_format($invoice['item_total_price'] - $invoice['item_discount']); ?></td>
				</tr>
		...
		<tfoot>
			<tr class="bg-gray">
				...
				<th class="text-right"><?php echo number_format($total_item_discount); ?></th>
				<th class="text-right"><?php echo number_format($total_net_amount); ?></th>
			</tr>
		</tfoot>
