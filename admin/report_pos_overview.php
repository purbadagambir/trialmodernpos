            ...
            <table class="table table-bordered table-striped mt-20">
              <tbody>
                <tr>
                  ...
                  <td class="w-50 text-left"><?php echo number_format(get_total_profit($from, $to));?></td>
                </tr>
                <tr>
                  <td class="w-50 bg-gray text-right"><?php echo trans('label_total_loss'); ?></td>
                  <td class="w-50 text-left"><?php echo number_format(get_total_loss($from, $to));?></td>
                </tr>
                <tr>
                  <td class="w-50 bg-gray text-right"><?php echo trans('label_net_profit'); ?></td>
                  <td class="w-50 text-left"><?php echo number_format(get_total_profit($from, $to) - get_total_loss($from, $to));?></td>
                </tr>
              </tbody>
            </table>
          </div>
