        ...
        <div class="box box-info mb-0">
          <div class="box-body deposit-today">
            <div class="row">
              ...
              <div class="col-sm-4 col-xs-4">
                <div class="description-block border-right">
                  <h2 class="description-header"><?php echo currency_format($banking_model->get_asset_amount(store_id())); ?></h2>
          ...
          <div class="box-footer">
            <div class="row">
              ...
              <div class="pr-15 col-md-4 col-xs-12">
                <div class="box box-default banking-box">
                  <div class="box-header with-border">
                    <h3 class="box-title"><?php echo trans('text_data_asset'); ?></h3>
                  </div>
                  <div class="box-body">
                    <div class="table-responsive" style="min-height:150px">
                      <table class="table table-striped no-margin">
                        <thead>
                          <tr class="bg-gray">
                            <th class="w-35 text-center"><?php echo trans('label_product'); ?></th>
                            <th class="w-45"><?php echo trans('label_stock'); ?></th>
                            <th class="w-20 text-right"><?php echo trans('label_amount'); ?></th>
                          </tr>
                        </thead>
                        <tbody>
                          <?php if ($transactions = $banking_model->getPurchase(store_id(), 3)) : ?>
                            <?php foreach ($transactions as $row) : ?>
                              <tr>
                                <td class="w-35 text-center"><?php echo $row['item_name'];?></td>
                                <td class="w-45 text-center"><?php echo $row['item_quantity'];?></td>
                                <td class="w-20 text-right"><?php echo currency_format($row['item_total']);?></td>
                              </tr>
                            <?php endforeach; ?>
                          <?php endif; ?>
                        </tbody>
                  ...
                  <div class="box-footer clearfix text-center">
                    <?php if (user_group_id() == 1 || has_permission('access', 'read_bank_transactions')) : ?>
                      <a href="<?php echo root_url();?>/admin/product.php"><?php echo trans('button_view_all'); ?> &rarr;</a>
                    <?php endif; ?>
                  </div>
                </div>
              </div>
