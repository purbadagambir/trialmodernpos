                    ...
                    <?php for ($i=0; $i < $prod['quantity']; $i++): ?>
                      <div class="item style<?php echo $per_page;?>">
                        <div class="item-inner">
                          ...
                          <?php endif;?>
						  <!-- update by Akbar 17/05/2022 -->
						  <div style="line-height:1.222;font-weight:700;">
                              <span style="font-size:10px;" class="barcode_name">Rak :<?php echo $product['box_name'];?></span>
                            </div>
							<div style="line-height:1.222;font-weight:700;">
                              <span style="font-size:10px;" class="barcode_name"><?php echo date("d-m-Y");?></span>
                            </div>
                          ...
                          <?php endif;?>
                          <?php if (isset($request->post['fields']['price']) && $request->post['fields']['price']):?>
                                <div style="font-size:20px;line-height:1.222;font-weight:700;">
                                  <?php if (isset($request->post['fields']['currency']) && $request->post['fields']['currency']):?>
                                  <?php echo '<span class="mb-9" style="font-size : 15px">'. get_currency_code().'</span>';?> 
                                  <?php endif;?>
                                  <?php echo '<span style="font-size : 45px">'. currency_format($product['sell_price']).'</span>';?></span>
