        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            <address class="mb-0 text-center">
              ...
              <?php endif; ?>
               <!-- Update by Henry Purba @ 19/05/2022 -->
              <!-- <p>
                <b>
              ...
              <p>
                <b>
                  <?php echo trans('label_Reference By'); ?>:
                </b>
                <?php echo get_customer_reference($customer['parent_id']); ?>
              </p>

              <?php if ($customer['total_points']) : ?>
                <p>
                  <b>
                    <?php echo trans('label_POINT'); ?>:
                  </b> 
                  <?php echo $customer['total_points']; ?>
                </p>
              <?php endif; ?>
